        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '32px' }}>
          <div style={{ position: 'relative' }}>
            ...
            {profile.profile_pic_url && !imgError ? (
              <img src={profile.profile_pic_url} alt="Profile" style={{ width: '84px', height: '84px', borderRadius: '50%', objectFit: 'cover', border: '2px solid var(--es-border)', opacity: uploadingPic ? 0.5 : 1 }} onError={() => setImgError(true)} />
            ) : (
